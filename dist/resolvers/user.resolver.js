    ...
    Query: {
        getUser: function (_, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokenVerify = context.tokenVerify;
                    ...
                    case 1:
                        infoUser = _a.sent();
                        if (!infoUser) {
                            return [2, { code: 400, message: "Token không hợp lệ!" }];
                        }
                        return [2, {
                                code: 200,
                                message: "Thành công!",
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        existUser = _a.sent();
                        if (existUser) {
                            return [2, { code: 400, message: "Email đã tồn tại!" }];
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        infoUser = _a.sent();
                        if (!infoUser) {
                            return [2, { code: 400, message: "Email hoặc mật khẩu không chính xác!" }];
                        }
                        return [2, {
                                code: 200,
                                message: "Thành công!",
